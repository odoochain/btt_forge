package forge.screens.zenman.views;
...
import forge.screens.zenman.controllers.CZenmanCatalog;
 ...
 *
 */
public enum VZenmanCatalog implements IVDoc<CZenmanCatalog> {
    SINGLETON_INSTANCE;
    ...
    @Override
    public CZenmanCatalog getLayoutControl() {
        return CZenmanCatalog.SINGLETON_INSTANCE;
    }
